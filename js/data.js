/* Guardian Motors Limited: shared product data (vehicles + genuine parts) */
const VEHICLES = [
  {
    ...
    features: ['1,000cc K-Next engine', 'Manual or automatic transmission', '~20 km per litre', 'Compact, easy city parking'],
  },
  {
    ...
    features: ['800cc F8D engine', '~25 km per litre', 'Spacious interior for its size', 'Low running costs'],
  },
  {
    ...
    features: ['SUV-styled crossover body', 'Raised seating position', 'Compact and manoeuvrable', 'Petrol engine'],
  },
  {
    ...
    features: ['ALLGrip 4x4 technology', 'Muscular SUV design', 'Two-tone colour options', 'Genuine off-road capability'],
  },
  {
    ...
    features: ['7-seater layout', '1.4-litre engine', '~15 km per litre', 'Family or commercial use'],
  },
  {
    ...
    features: ['11th-generation design', 'Low fuel and running costs', 'Strong payload capacity', 'Built for daily business use'],
  },
  {
    ...
    features: ['199cc single-cylinder engine', 'Electric starter', 'Telescopic front forks', '13-litre fuel tank'],
  },
  {
    ...
    features: ['125cc engine', 'Dual seat', 'Low fuel consumption', 'Ideal for urban commuting'],
  },
  {
    ...
    features: ['125cc engine', 'Dual seat', 'Reliable, robust build', 'Strong value for money'],
  },
];
...
const PART_CATEGORIES = [
  ...
  { id: 'body', name: 'Body & Trim' },
  { id: 'moto', name: 'Motorcycle' },
];

const PARTS = [
  { id: 'oil-filter', name: 'Genuine Oil Filter', category: 'engine', compatible: 'All Suzuki cars', desc: 'Manufacturer-specified oil filter for scheduled servicing.' },
  { id: 'air-filter', name: 'Genuine Air Filter', category: 'engine', compatible: 'All Suzuki cars', desc: 'OEM air filter element, correct fit and airflow rating.' },
  { id: 'spark-plug-set', name: 'Spark Plug Set', category: 'engine', compatible: 'Alto K10, Alto 800, S-Presso, Ertiga', desc: 'Full genuine spark plug set for petrol engines.' },
  { id: 'timing-belt-kit', name: 'Timing Belt Kit', category: 'engine', compatible: 'Vitara, Ertiga', desc: 'Genuine timing belt and tensioner kit.' },
  { id: 'brake-pads-front', name: 'Front Brake Pads', category: 'brakes', compatible: 'All Suzuki cars', desc: 'Genuine front brake pad set, manufacturer friction rating.' },
  { id: 'brake-pads-rear', name: 'Rear Brake Pads', category: 'brakes', compatible: 'All Suzuki cars', desc: 'Genuine rear brake pad set for scheduled replacement.' },
  { id: 'brake-discs', name: 'Brake Discs (Pair)', category: 'brakes', compatible: 'Vitara, Ertiga, Super Carry', desc: 'Genuine ventilated brake discs, front pair.' },
  { id: 'headlight-assembly', name: 'Headlight Assembly', category: 'electrical', compatible: 'Alto K10, Alto 800, Ertiga', desc: 'Genuine replacement headlight unit.' },
  { id: 'battery', name: 'Genuine Battery', category: 'electrical', compatible: 'All Suzuki cars', desc: 'OEM-spec battery, correct cold-cranking amps for your model.' },
  { id: 'alternator', name: 'Alternator', category: 'electrical', compatible: 'Vitara, Ertiga, Super Carry', desc: 'Genuine alternator unit, direct fit replacement.' },
  { id: 'side-mirror', name: 'Side Mirror Assembly', category: 'body', compatible: 'All Suzuki cars', desc: 'Genuine door mirror, manual or electric variants available.' },
  { id: 'bumper-front', name: 'Front Bumper', category: 'body', compatible: 'Alto K10, Alto 800, S-Presso', desc: 'Genuine front bumper cover, primed for paint.' },
  { id: 'windscreen', name: 'Windscreen', category: 'body', compatible: 'All Suzuki cars', desc: 'Genuine laminated windscreen, correct fit and tint.' },
  { id: 'clutch-kit', name: 'Clutch Kit', category: 'engine', compatible: 'Alto K10, Alto 800, Ertiga', desc: 'Genuine clutch plate, cover and release bearing kit.' },
  { id: 'moto-chain-sprocket', name: 'Chain & Sprocket Kit', category: 'moto', compatible: 'DR200SE, EN125-2A, EN125-HUZ', desc: 'Genuine drive chain and front/rear sprocket set.' },
  { id: 'moto-brake-shoes', name: 'Motorcycle Brake Shoes', category: 'moto', compatible: 'DR200SE, EN125-2A, EN125-HUZ', desc: 'Genuine drum brake shoe set for Suzuki motorcycles.' },
  { id: 'moto-spark-plug', name: 'Motorcycle Spark Plug', category: 'moto', compatible: 'DR200SE, EN125-2A, EN125-HUZ', desc: 'Genuine spark plug for Suzuki motorcycle engines.' },
  { id: 'moto-air-filter', name: 'Motorcycle Air Filter', category: 'moto', compatible: 'DR200SE, EN125-2A, EN125-HUZ', desc: 'Genuine air filter element for Suzuki motorcycles.' },
];
...
if (typeof module !== 'undefined') {
  module.exports = { VEHICLES, PART_CATEGORIES, PARTS, findVehicle, findPart };
}
